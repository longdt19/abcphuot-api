...
class CreateOrderForm(BaseForm):
    ...
    phone = fields.String(validate=STRING_LENGTH_VALIDATORS['LONG'], required=True)
    name = fields.String(validate=STRING_LENGTH_VALIDATORS['LONG'], required=True)
...
class ListSimOrderForm(BaseListForm):
    search_text = fields.String(validate=STRING_LENGTH_VALIDATORS['LONG'])
    product_type = fields.String(validate=STRING_LENGTH_VALIDATORS['LONG'])
#
# class CreateOrderWifi(BaseForm):
#     product_id = IdField(required=True)
